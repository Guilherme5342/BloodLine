...
{
    m_angle += (InputManager::IsKeyDown(SDLK_d) - InputManager::IsKeyDown(SDLK_a)) * m_angularVelocity * deltaTime;
    m_linearSpeed += (InputManager::IsKeyDown(SDLK_w) - InputManager::IsKeyDown(SDLK_s)) * m_linearVelocity;
    // desacelerar
