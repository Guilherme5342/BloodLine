...
public:
    ...
    static inline bool KeyPress(SDL_Keycode key) { return GetInstance().__KeyPress(key); }
    static inline bool KeyRelease(SDL_Keycode key) { return GetInstance().__KeyRelease(key); }
    static inline bool IsKeyDown(SDL_Keycode key) { return GetInstance().__IsKeyDown(key); }
...
private:
    ...
    bool __KeyPress(SDL_Keycode key) const;
    bool __KeyRelease(SDL_Keycode key) const;
    bool __IsKeyDown(SDL_Keycode key) const;
    ...
    std::int32_t GetKeyIndex(SDL_Keycode key) const;
